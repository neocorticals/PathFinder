    ...
    public class PermissionsImplementation : IPermissions
    {
        ...
        static Permission GetPermissionForManifestName(string permission)
        {
            switch (permission)
            {
                ...
                case Manifest.Permission.BluetoothAdmin:
                ...
                case Permission.Bluetooth:
                    {
                        ...
                        if (HasPermissionInManifest(Manifest.Permission.BluetoothAdmin))
                                permissionNames.Add(Manifest.Permission.BluetoothAdmin); 
                    }
                    break;
                default:
                    return null;
        ...
        public void OpenBluetoothSettings()
        {
            try
            {
                ...
                CrossCurrentActivity.Current.Activity.StartActivity(intentOpenBluetoothSettings);
            }
            catch (Exception)
            {
            }
        ...
        {
            Android.Locations.LocationManager lm = (Android.Locations.LocationManager)CrossCurrentActivity.Current.Activity.GetSystemService(Context.LocationService);
        ...
        public void OpenLocationSettings()
        {
            try
            {
                ...
                intentOpenLocationSettings.SetAction(Android.Provider.Settings.ActionLocationSourceSettings);
                CrossCurrentActivity.Current.Activity.StartActivity(intentOpenLocationSettings);
            }
            catch (Exception)
            {
            }
